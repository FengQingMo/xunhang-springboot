...
public class RabbitConstant {
    ...
    public static final String Message_QUEUE_NAME = "wxinfo.queue";
    public static final String Message_EXCHANGE_NAME = "wxinfo.exchange";
    public static final String Message_ROUTING_KEY_NAME = "wxinfo.routing.key";
}
